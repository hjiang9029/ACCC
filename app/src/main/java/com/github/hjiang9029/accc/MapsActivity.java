...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng newWest = new LatLng(49.206405, -122.909843);
        ...
        Polyline polyline1 = googleMap.addPolyline(new PolylineOptions()
                .clickable(true)
                .add(
                        new LatLng(49.206405, -122.909843),
                        new LatLng(49.213638, -122.910427)));

        mMap.addMarker(new MarkerOptions().position(new LatLng(49.210035, -122.914010)).title("Washroom")
